...
public class Main {
	...
	// write your code here
        ...
        System.out.print("Ingerse el nivel que desea ver: "); int level = tec.nextInt();
        System.out.println("El valor de los nodos de la altura " + level + " del arbol 1 es: ");
        LinkedList<ArbolBinario> nodosRestultates = raiz.nodosAltura(level);
        for (ArbolBinario c : nodosRestultates) {
            System.out.println(c.dato);
        }

        System.out.println("El valor de los nodos de la altura " + level + " del arbol 2 es: ");
        LinkedList<ArbolBinario> nodosRestultates2 = raiz2.nodosAltura(level);
        for (ArbolBinario c : nodosRestultates2) {
            System.out.println(c.dato);
        }
