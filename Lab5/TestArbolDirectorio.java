public class TestArbolDirectorio {
	...
	public static void main(String[] args) {
		...
		boolean chek = ad.crearCarpeta("root", "Carpeta 1");
		if (chek == true) System.out.println("CARPETA CREADA");
		chek = ad.crearCarpeta("root", "Carpeta 2");
		if (chek == true) System.out.println("CARPETA CREADA");
		chek = ad.crearCarpeta("root", "Carpeta 3");
		if (chek == true) System.out.println("CARPETA CREADA");
		ad.print();
		System.out.println("Current size: " + ad.size());
